...
export const TECHNOMascot = ({ size = "md", isThinking = false }: { size?: "sm" | "md" | "lg", isThinking?: boolean }) => {
  const scale = {
    sm: 0.22,
    md: 0.45,
    lg: 1.0
  ...
  return (
    ...
    >
      <div style={{ transform: `scale(${scale})`, transformOrigin: 'center' }}>
        <svg id="techno" width="180" height="180" viewBox="0 0 180 180" xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision">
          <defs>
