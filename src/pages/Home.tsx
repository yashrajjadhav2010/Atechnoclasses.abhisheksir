      ...
      <section className="py-12 md:py-20">
        <div className="bg-emerald-950 preserve-dark rounded-[3rem] md:rounded-[5rem] p-8 md:p-12 lg:p-20 relative overflow-hidden group">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2.5rem] p-8 lg:p-10 shadow-2xl w-full">
                <form
                  onSubmit={(e) => {
                    e.preventDefault();
                ...
                >
                  ...
                  <div>
                    ...
                    <textarea
                      className="w-full bg-emerald-900/50 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all min-h-[120px] resize-none"
