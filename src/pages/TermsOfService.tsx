  ...
  const terms = [
    {
      ...
      icon: Scale,
      content: 'By accessing A TECHNO, you are granted a non-exclusive license to use the training terminal for educational purposes. Commercial redistribution of the system components is strictly prohibited.'
    },
    {
    ...
    },
    {
      ...
      icon: Gavel,
      content: 'A TECHNO Command reserves the right to modify system parameters, update module sets, and adjust operational thresholds without prior notice to ensure optimal training performance.'
    },
    {
      title: 'AI Usage & New Features',
      icon: CheckCircle,
      content: 'The terminal now includes integrated AI logic flows (TECHNO Live Engine) and advanced UI alignments simulating main test events. Engagement with AI analysis is subject to defined daily quotas (10 per operator terminal). Any circumvention of these limitations via automated scripts or network tunneling constitutes a breach of protocol.'
    }
  ];
    ...
    <div className="max-w-4xl mx-auto space-y-12 pb-20 mt-10">
      <section className="text-center space-y-4">
        ...
        <p className="text-emerald-900/40 font-medium max-w-xl mx-auto">
          The legal framework governing the interaction between operators and the A TECHNO network.
        </p>
      </section>
      ...
      <div className="text-center">
        <p className="text-xs font-black text-emerald-900/20 uppercase tracking-widest">
          © 2026 A TECHNO Command • All Protocols Enforced
        </p>
      </div>
    </div>
  );
