                        ...
                        {q.explanation ? (
                          ...
                          <div className="mt-6 flex justify-start">
                             ...
                             >
                                ...
                                {explainingIds.includes(q.id) ? 'Synthesizing Logic...' : 'Explain with TECHNO AI'}
                             </button>
                          </div>
                        )}
                     </div>
        ...
        {showFeedbackModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="h-[400px] md:h-[500px] p-6 md:p-8 overflow-y-auto">
                <form
                  onSubmit={(e) => {
                    e.preventDefault();
                    handleCloseFeedback();
                ...
                >
                  <div>
                    <label className="block text-[10px] font-black uppercase tracking-widest text-emerald-600 mb-2">
                      Operator Name
                    </label>
                    <input
                      type="text"
                      className="w-full bg-emerald-50 border border-emerald-100 rounded-xl px-4 py-3 text-emerald-950 placeholder-emerald-900/30 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                  ...
                  <div>
                    ...
                    <textarea
                      className="w-full bg-emerald-50 border border-emerald-100 rounded-xl px-4 py-3 text-emerald-950 placeholder-emerald-900/30 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all min-h-[120px] resize-none"
