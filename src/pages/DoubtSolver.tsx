...
import { TECHNOMascot } from '../components/TECHNOMascot';
...
export default function DoubtSolver() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const limitData = localStorage.getItem('techno_usage_limit');
      if (limitData) {
    ...
    <div className="flex flex-col h-[100dvh] bg-white relative overflow-hidden text-[#0d0d0d]">
      ...
      <div className="flex items-center justify-between p-3 md:p-4 border-b border-gray-100 bg-white/80 backdrop-blur-md z-30 sticky top-0">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 flex flex-col items-center">
          ...
          <span className="text-[7px] md:text-[8px] font-extrabold uppercase tracking-[0.4em] text-gray-400 mt-1.5 select-none pl-[0.4em]">by A TECHNO</span>
        </div>
            ...
            {messages.length === 0 && !loading && (
              ...
              >
                ...
                <div className="relative">
                  ...
                  >
                    <Sparkles size={12} className="animate-pulse" /> TECHNO AI 2.0 Online
                  </motion.div>
                    ...
                    <div className="flex items-center gap-3 mb-2 px-2">
                      <div className="shrink-0">
                        <div className="w-8 h-8 md:w-10 md:h-10 bg-white rounded-full shadow-md border border-emerald-100 flex items-center justify-center relative inner-shadow-emerald ring-4 ring-gray-50 scale-90 md:scale-100">
                          <TECHNOMascot size="sm" />
                        </div>
                      </div>
                      <span className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.2em] text-emerald-700">TECHNO Solves</span>
                    </div>
            ...
            {loading && (
              ...
              >
                <div className="max-w-3xl mx-auto w-full flex gap-4 md:gap-6">
                  <TECHNOMascot size="sm" isThinking />
                  <div className="flex-1 space-y-2 pt-1 text-[#374151] animate-pulse">
                     <span className="text-xs font-bold uppercase tracking-wider text-gray-400">TECHNO is calculating...</span>
