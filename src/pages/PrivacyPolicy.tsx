  ...
  const policies = [
    {
      ...
      icon: Eye,
      content: 'A TECHNO operates primarily as a client-side terminal. Most of your training data, including session scores and progress, is stored locally in your browser storage. We do not track personal identity unless explicitly provided for system synchronization.'
    },
    {
    ...
    },
    {
      title: 'Consent',
      icon: Shield,
      content: 'By operating the A TECHNO terminal, you consent to our localized data persistence protocols. You may purge your system history at any time via the Settings terminal.'
    },
    {
      title: 'AI Intelligence & Features',
      icon: Eye,
      content: 'New updates feature the TECHNO Live Engine to analyze and provide step-by-step solutions to problems. Query data sent to the AI processing layer is utilized solely to return intelligent insights and is not stored or shared for external model training. Our platform continually adds new features designed to provide a targeted JEE experience while upholding data integrity.'
    }
  ];
    ...
    <div className="max-w-4xl mx-auto space-y-12 pb-20 mt-10">
      <section className="text-center space-y-4">
        ...
        <p className="text-emerald-900/40 font-medium max-w-xl mx-auto">
          Ensuring operational secrecy and data integrity for all operators within the A TECHNO network.
        </p>
      </section>
