  ...
  const sections = [
    {
      ...
      icon: Zap,
      content: 'A TECHNO is a high-performance training terminal designed for JEE Advanced aspirants. Our modular system allows you to tackle specific chapters with precision-guided micro-tests.'
    },
    {
    ...
    <div className="max-w-4xl mx-auto space-y-12 pb-20 mt-10">
      <section className="text-center space-y-4">
        ...
        <p className="text-emerald-900/40 font-medium max-w-xl mx-auto">
          Operational guide for the A TECHNO training environment. Standardized procedures for maximum efficiency.
        </p>
      </section>
