      ...
      <section className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-8">
        <div className="space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary/10 rounded-full border border-primary/20">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-primary">A TECHNO Library</span>
          </div>
               ...
               <div className="relative z-10 space-y-6">
                  ...
                  <div className="space-y-2">
                     ...
                     <p className="text-xs font-medium text-emerald-100/60 leading-relaxed">
                        A Techno AI can generate a distinct revision schedule combining formulas, notes, and question banks based on your weaknesses.
                     </p>
                  </div>
