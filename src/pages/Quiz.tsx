...
export default function Quiz() {
  ...
  const handleAiExplain = async () => {
    ...
    if (usage.count >= 10) {
      setAiLimitError("Daily TECHNO AI limit of 10 questions reached! Please try tomorrow.");
                                ...
                                <div className="flex items-center justify-between mb-8 md:mb-10 border-b border-white/5 pb-6">
                                  ...
                                  <div className="hidden md:flex flex-col items-end">
                                    <div className="flex items-center gap-2">
                                      ...
                                      <span className="text-[10px] font-black uppercase tracking-widest text-white/40">TECHNO Live Engine</span>
                                    </div>
